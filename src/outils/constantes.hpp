...
string const params_images = "{rep-src | ../../../../images/test_mfs | Dossier contenant la séquence à analyser}{extension | png | Extension des images à rechercher}{nb-img | -1 | Nombre d'images à charger}{tau | 2 | Temps de stabilité (valeur de T)}";
